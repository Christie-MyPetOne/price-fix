        ...
        <table className="w-full text-sm text-left divide-border-dark">
          ...
          <tbody className="divide-y divide-border-dark">
            {paginatedProducts.map((product, index) => {
              ...
              let stockHealthStatus = "Excelente";
              if (daysLeft <= produtoConfig.excelente)
                stockHealthStatus = "Excelente";
              else if (daysLeft <= produtoConfig.moderado)
                stockHealthStatus = "Média";
              else if (daysLeft <= produtoConfig.risco)
                stockHealthStatus = "Risco";
              else stockHealthStatus = "Parado";
